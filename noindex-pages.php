...
function noinp_post_types() {
	// Allow developers to set specific post types
	$allowed_post_types = apply_filters( 'noindex-pages-post-types', null );
	if ( !empty($allowed_post_types) ) return $allowed_post_types;
	
	// Default to work on all "public" post types.
